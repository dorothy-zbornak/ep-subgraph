...
export class UniswapPairFactory extends ethereum.SmartContract {
  static bind(address: Address): UniswapPairFactory {
    return new UniswapPairFactory("UniswapPairFactory", address);
  }
